...
|-------|------------|---------------|------|--------------------|---------------------|---------|
| AM | within GP+2MiB | `addiu.w $a0, $gp, %tlsgd(symbol); <call to __tls_get_addr>` | 4 | R_NANOMIPS_TLS_GD symbol | GOT\[n]: R_NANOMIPS_TLS_DTPMOD symbol; GOT\[n+1]: R_NANOMIPS_TLS_DTPREL symbol | The address of the symbol will be returned in $a0 by __tls_get_addr.|
...
|-------|------------|---------------|------|--------------------|---------------------|---------|
|**TLS Block Address**|||||||
| AM | within GP+2MiB | addiu.w $a0, $gp, %tlsld(symbol); <call to __tls_get_addr> | 4 | R_NANOMIPS_TLS_LD symbol | GOT\[n]: R_NANOMIPS_TLS_DTPMOD symbol; GOT\[n+1]: 0 | The address of the symbol will be returned in $a0 by __tls_get_addr.|
