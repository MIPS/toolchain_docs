...
<!-- #AND modified stepxmp to use the example attribute set 
	
-->
    <xsl:attribute-set name="stepxmp" use-attribute-sets="example common.border">
    <xsl: attribute name="color">green</xsl:>
    <xsl: attribute name="font-weight">bold</xsl:>
   <xsl: attribute name="background-color">green</xsl:>
	...
	#AND need some alterations should not be white -->
    ...
    <xsl:attribute-set name="chhead.choptionhd"><xsl:template match="…">
...
<!-- #AND turn off the default for choption -->
    ...
    <xsl:attribute-set name="chhead.choptionhd__content" use-attribute-sets="common.table.body.entry"><xsl:template match="…">
<fo:block color="black">
  <xsl:apply-templates/>
</fo:block>
</xsl:template>
    ...
    <xsl:attribute-set name="chhead.chdeschd"><xsl:attribute name="color">black</xsl:attribute></xsl:attribute-set>

    <xsl:attribute-set name="chhead.chdeschd__content" use-attribute-sets="common.table.body.entry"></xsl:attribute-set>

    <xsl:attribute-set name="chrow.choption" use-attribute-sets="common.table.body.entry"><xsl:template match="…">
<fo:block color="black">
  <xsl:apply-templates/>
</fo:block>
</xsl:template>
    ...
    <xsl:attribute-set name="chrow.choption__keycol-content" use-attribute-sets="common.table.body.entry"><xsl:attribute name="font-weight">bold</xsl:attribute>
    <xsl:template match="…">
<fo:block color="black">
  <xsl:apply-templates/>
</fo:block>
    ...
    <xsl:attribute-set name="chrow.choption__content" use-attribute-sets="common.table.body.entry"><xsl:template match="…">
<fo:block color="black">
  <xsl:apply-templates/>
</fo:block>
</xsl:template>
    ...
    <xsl:attribute-set name="chrow.chdesc__keycol-content" use-attribute-sets="common.table.body.entry">
