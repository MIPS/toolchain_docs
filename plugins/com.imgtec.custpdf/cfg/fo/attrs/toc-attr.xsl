...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<!-- #AND 2303 added color to the output -->
...
<!-- #AND alter colour of border to img purple  by directing to a different border attribute -->
     <xsl:attribute-set name="__toc__mini__summary" use-attribute-sets="img.border__left">
