...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="createDefaultLayoutMasters">
		...
		<fo:region-after region-name="first-frontmatter-footer" xsl:use-attribute-sets="region-after"/>
            ...
            <!--BODY simple masters
	    #AND change will alter body-first to call odd-body-footer instead of first-body-footer
	    12102017 called odd-body-header instead of first-body-header for first page. 
	    -->
