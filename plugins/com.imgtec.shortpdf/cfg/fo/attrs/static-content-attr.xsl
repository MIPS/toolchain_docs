...
<!-- #AND style for the bookmain title in the header on first page .  -->
   <xsl:attribute-set name="short-bookmain">
...
<!-- #AND style for the booksecondary title in the header on first page .  -->
   <xsl:attribute-set name="short-booksecondary">
...
<!-- #AND style for the bookmain title in the header on first page .  -->
   <xsl:attribute-set name="short-legal">
...
<!-- #AND template for the disclaimer.  -->
 ...
 <xsl:attribute-set name="__frontmatter__footer" use-attribute-sets="footer">
    ...
    <!-- #AND shortform confidentiality footer -->
 <xsl:attribute-set name="__firstpage__footer__confidentiality">
