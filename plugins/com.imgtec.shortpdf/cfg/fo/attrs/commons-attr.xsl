...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  border set to MIPS blue-->
	<xsl:attribute-set name="img.border__left">
    <xsl:attribute name="border-start-style">solid</xsl:attribute>
    <xsl:attribute name="border-start-width">1pt</xsl:attribute>
    <xsl:attribute name="border-start-color">#0066B5</xsl:attribute>
  </xsl:attribute-set>
...
-->
	...
	<xsl:attribute name="border-after-style">solid</xsl:attribute>
	<xsl:attribute name="border-after-color">#0066B5</xsl:attribute>
	...
	This level is used for main headings after the ToC 
		...
		Removed page break before as per branding pdf 
		<xsl:attribute name="break-before">page</xsl:attribute>
...
-->
    <xsl:attribute-set name="topic.topic.topic.topic.title" use-attribute-sets="base-font common.title">
        ...
        <xsl:attribute name="start-indent"><xsl:value-of select="$side-col-width"/></xsl:attribute>
        <xsl:attribute name="font-weight">bold</xsl:attribute>
	<xsl:attribute name="color">#0066B5</xsl:attribute>
	<xsl:attribute name="padding-bottom">0pt</xsl:attribute>
        <xsl:attribute name="keep-with-next.within-column">always</xsl:attribute>
    </xsl:attribute-set>
...
<!-- #AND 
	...
	#AND 10102017 commenting out the border
...
<!-- #AND 24012017 switched first select from even to auto, to eliminate blank last page -->
