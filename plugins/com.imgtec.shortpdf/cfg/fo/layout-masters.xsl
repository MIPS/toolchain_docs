...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="createDefaultLayoutMasters">
        <fo:layout-master-set>
            <!-- Frontmatter simple masters  #AND - commented out the front matter masters as I don't want any of them.
		...
		<fo:region-after region-name="first-frontmatter-footer" xsl:use-attribute-sets="region-after"/>
            ...
            <!--BODY simple masters
	    #AND Call special header for first page - and set it to call first-body-footer
	    -->
            ...
            <!-- #AND This should set up the added even blank pages and no others - Doesn't work - it gets added to non-blank even pages.
	    <fo:simple-page-master master-name="body-last" xsl:use-attribute-sets="simple-page-master">
		
		<fo:region-body xsl:use-attribute-sets="region-body.even"/>
                <fo:region-after region-name="disclaimer-statement" xsl:use-attribute-sets="blank-region-after"/>
		...
		<fo:region-body xsl:use-attribute-sets="region-body.even"/>
          ...
          <!-- #AND comment out call to generate front-matter <xsl:call-template name="generate-page-sequence-master">
